...
window.grunticon=function(e){if(e&&3===e.length){var n=window,t=!(!n.document.createElementNS||!n.document.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect||!document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")||window.opera&&-1===navigator.userAgent.indexOf("Chrome")),s=function(s){var a=n.document.createElement("link"),o=n.document.getElementsByTagName("script")[0];a.rel="stylesheet",a.href=e[s&&t?0:s?1:2],o.parentNode.insertBefore(a,o)},a=new n.Image;a.onerror=function(){s(!1)},a.onload=function(){s(1===a.width&&1===a.height)},a.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="}},grunticon(["/themes/ell_cranell/assets/icons/grunticon/icons.data.svg.css","/themes/ell_cranell/assets/icons/grunticon/icons.data.png.css","/themes/ell_cranell/assets/icons/grunticon/icons.fallback.css"]);
jQuery(function(t){t(".kontaktformular .js-form-item input, .kontaktformular .js-form-item textarea").each(function(){var e=t(this),i=e.parents(".js-form-item");e.focusin(function(){i.addClass("widget-focus")}).focusout(function(){i.removeClass("widget-focus")}),e.keyup(function(e){t(this).val().length?i.addClass("widget-content"):i.removeClass("widget-content")})}),t(".hero-video").each(function(){var e=t(this),i=e.find("video");i.attr("playsinline","")}),t("input[type=checkbox],input[type=radio], input[type=text], input[type=email], textarea").uniform({})});
jQuery(function(a){var i=a(".field--name-field-paragraphs-main, .field--name-field-all-design-body"),n=i.find(".text-default"),e=[];if(n.each(function(){var i=a(this),n=i.attr("id");title=i.attr("data-titlenav"),n&&e.push([n,title])}),e.length){var t=a('<nav id="nav-anchor" class="nav-anchor"></nav>'),o=a("<ul></ul>");a.each(e,function(i,n){var e=a('<li><a href="#'+n[0]+'"><span>'+n[1]+"</span></a></li>");e.find("a").click(function(i){i.preventDefault();var e=a("#"+n[0]).offset().top-a(window).height()/2+60;a("html,body").animate({scrollTop:e})}),e.appendTo(o)}),o.appendTo(t),t.appendTo(a("body"))}}),jQuery(function(a){var i=a(".nav-anchor");a(window).bind("resize load scroll",function(){i.find("ul li a").each(function(){var i=a(this),n=i.attr("href"),e=n.split("#");if("undefined"!=typeof e[1]){var t=a("#"+e[1]),o=t.offset().top,l=o+t.height(),d=a(window).scrollTop()+a(window).height()/2;d>=o?i.addClass("is-post"):i.removeClass("is-post"),d>=o&&d<l?i.addClass("is-active"):i.removeClass("is-active")}})})});
jQuery(function(){var e=jQuery(".navigation-mobile"),i=e.find("ul:not(.level_1)"),t=e.find("div.submenu"),a=0;i.each(function(){var e=jQuery(this),i=e.parent(),t=i.children("a");e.prepend('<li class="navigation-mobile__headline">'+t.text()+"</li>"),e.prepend('<li class="navigation-mobile__back"><a href="#" class="navigation-mobile__back">Hauptmenü</a></li>')}),jQuery("a.navigation-mobile__back").click(function(i){i.preventDefault(),a--,a=Math.max(0,a);var t=!1;if(0==a){var l=e.find("ul.level_1").outerHeight()+jQuery(".mobile-popup").find(".navigation-mobile-extra").outerHeight(),o=jQuery(this).parents("ul").first().height();t=!0}else var l=jQuery(this).parents("ul").first().parents("ul").first().height(),o=jQuery(this).parents("ul").first().height();var r=Math.max(l,o);jQuery(".mobile-popup__navigation__inner").height(r),setTimeout(function(){t?jQuery(".mobile-popup__navigation__inner").removeAttr("style"):jQuery(".mobile-popup__navigation__inner").height(l)},300),jQuery(".mobile-popup").attr("class",jQuery(".mobile-popup").attr("class").replace(/mobile-popup--level_[0-9]+/,"").trim()),jQuery(".mobile-popup").addClass("mobile-popup--level_"+a),jQuery(this).parents("li.navigation-mobile__active").first().removeClass("navigation-mobile__active")}),t.click(function(i){if(i.preventDefault(),a++,1==a)var t=jQuery(this).parent().find("ul").first().height(),l=e.find("ul.level_1").outerHeight();else var t=jQuery(this).parent().find("ul").first().height(),l=jQuery(this).parents("ul").first().height();var o=Math.max(t,l);jQuery(".mobile-popup__navigation__inner").height(o),setTimeout(function(){jQuery(".mobile-popup__navigation__inner").height(t)},300),jQuery(".mobile-popup").attr("class",jQuery(".mobile-popup").attr("class").replace(/mobile-popup--level_[0-9]+/,"").trim()),jQuery(".mobile-popup").addClass("mobile-popup--level_"+a),jQuery(this).parents().addClass("navigation-mobile__active")}),jQuery(".mobile-popup__close").click(function(e){jQuery(".mobile-popup").attr("class",jQuery(".mobile-popup").attr("class").replace(/mobile-popup--level_[0-9]+/,"").trim()),jQuery(".mobile-popup").find("li.navigation-mobile__active").removeClass("navigation-mobile__active"),jQuery(".mobile-popup__navigation__inner").removeAttr("style"),a=0}),jQuery(".burger").click(function(){jQuery("body").addClass("nav-open")}),jQuery(".mobile-popup__close").click(function(){jQuery("body").removeClass("nav-open")})});
jQuery(function(l){var e=l("#block-navigationprimary"),n=e.find("ul.level_2"),i=e.find("ul.level_3");n.each(function(){var e=l(this),n=e.children().filter(".submenu");1==n.length&&e.addClass("level_2-wide")}),i.each(function(){var e=l(this),n=e.children();n.length>5&&e.parents("ul.level_2 > li").addClass("submenu-long")})});
jQuery(function(e){var a=e(".quiz__open");a.click(function(a){a.preventDefault();var n=e('<div class="quiz"></div>'),i=e('<div class="quiz__inner"></div>'),o=e('<button class="quiz__close icon--close"></button>'),c=e('<iframe src="/haarausfall-test" frameborder="0"></iframe>');e("body").append(n),i.appendTo(n),c.appendTo(i),o.appendTo(i),o.click(function(e){e.preventDefault(),n.remove()})})});
jQuery(function(e){e(".slider-rating").each(function(){var i=e(this),r=i.find(".slider-rating__item > div");i&&r.addClass("slider-rating-slider owl-carousel")}),e(".slider-rating-slider").owlCarousel({dots:!1,loop:!0,nav:!0,margin:5,responsive:{0:{items:1,center:!0},620:{items:2,center:!1},880:{items:3}}}),e(".hero-slider-slider").owlCarousel({items:1,dots:!0,loop:!0,nav:!1})});
jQuery.fn.videoSize=function(){jQuery(this).each(function(){var e=jQuery(this),i=e.find("video");if(i.removeAttr("style"),null==i.height()||null==i.width())var t=setInterval(function(){i=e.find("video"),null!=i.height()&&null!=i.width()&&(e.videoSize(),clearInterval(t))},10);if(jQuery(window).width()<600&&e.width()<i.width()&&e.height()<i.height()){var d=i.height()/i.width();e.width()*d<e.height()?(i.height(e.height()),i.width(e.height()/d)):(i.width(e.width()),i.height(e.width()*d))}})},jQuery.fn.headerbackground=function(e){var i=$(this),t=i.attr("data-"+e),d=jQuery("<video autoplay loop preload muted playsinline></video>"),h=[];h.push(jQuery('<source src="assets/videos/'+t+'.mp4" type="video/mp4">')),h.push(jQuery('<source src="assets/videos/'+t+'.ogv" type="video/ogg">')),h.push(jQuery('<source src="assets/videos/'+t+'.webm" type="video/webm">')),jQuery.each(h,function(e,i){i.appendTo(d)}),i.empty(),d.appendTo(i)};var headermode=!1;jQuery(window).bind("load resize",function(){jQuery(".videoswitch").videoSize();var e="mobile";jQuery(window).width()>721&&(e="desktop"),e!==headermode&&(headermode=e,jQuery(".videoswitch").each(function(){jQuery(this).headerbackground(e)}))});;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
